...
def get_target_coverage_after_refining(k_spectrum_data, read_coverage, inversion_point):
    """
    ...
    :param inversion_point: the point of inversion (before which, all are errors)
